import eraLogo from 'assets/svg/era_logo_round.svg'
import eraSquareLogoUrl from 'assets/svg/era_logo_square.svg'
import { SupportedChainId } from 'constants/chains'
import ms from 'ms.macro'

import { SupportedL1ChainId, SupportedL2ChainId } from './chains'
import { PLASMA_BNB_LIST, ZKSYNC_ERA_LIST } from './lists'
...
const CHAIN_INFO: ChainInfoMap = {
  ...
  [SupportedChainId.ZKSYNC_ERA]: {
    ...
    infoLink: 'https://info.uniswap.org/#/era/',
    label: 'zkSync Era',
    logoUrl: eraLogo,
    circleLogoUrl: eraLogo,
    squareLogoUrl: eraSquareLogoUrl,
    nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
    defaultListUrl: PLASMA_BNB_LIST,
  },
  [SupportedChainId.ZKSYNC_ERA_TESTNET]: {
    networkType: NetworkType.L2,
    blockWaitMsBeforeWarning: ms`10m`,
    bridge: 'https://goerli.bridge.zksync.io',
    docs: 'https://era.zksync.io/docs/',
    ...
    squareLogoUrl: eraSquareLogoUrl,
    nativeCurrency: { name: 'Ether', symbol: 'ETH', decimals: 18 },
    defaultListUrl: ZKSYNC_ERA_LIST,
  },
}
